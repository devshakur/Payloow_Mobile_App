...
import InvestorFeaturedBusiness from "./InvestorFeaturedBusiness";
...
const InvestorDashboard: FunctionComponent<InvestorDashboardProps> = ({
  navigation,
}) => {
          ...
          })),
          {
            ...
            onPress: () => {
              ...
              navigation.reset({
                index: 0,
                routes: [
                  { name: "InvestorHomeNavigator" as keyof RootStackParamList },
                ],
              });
            },
          },
  ...
  return (
    <Screen backgroundColor={Colors.app.screen}>
      ...
      <BecomeInvestor onClose={() => setVisible(false)} isVisible={visible} />
    </Screen>
  );
};
