...
const ElectricitySummary: FunctionComponent<ElectricitySummaryProps> = ({
  ...
  const handlePurchase = async (pin: string) => {
    ...
    setLoading(false);
    setResponseMessage(responseData.data?.data.token || "");
    showModal("success");
  };
          ...
          <View style={styles.summaryContents}>
            ...
            <View style={styles.innerConatiner}>
              <View style={styles.innerConatinerContent}>
                ...
                <AppText style={styles.value}>{meterNumber}</AppText>
              </View>
              ...
              <View style={styles.innerConatinerContent}>
                ...
                <AppText style={[styles.value, { fontSize: 8 }]}>
                  {address}
                </AppText>
              </View>
            ...
            <View style={[styles.innerConatiner, { height: 100 }]}>
              <View style={styles.innerConatinerContent}>
